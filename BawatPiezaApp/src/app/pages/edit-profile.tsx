...
const makeStyles = (c: ThemeColors) => {
  ...
  msgOk: { color: '#15803D', fontSize: 12, fontWeight: '700', fontFamily: fonts.bold, marginBottom: 10 },
  msgErr: { color: '#B91C1C', fontSize: 12, fontWeight: '700', fontFamily: fonts.bold, marginBottom: 10 },
